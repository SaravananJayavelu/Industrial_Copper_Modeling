...
if selected == "Data Prediction":
    ...
    with tab1:    
            ...
            if submit_button and flag==0:
                with open(r"C:\GUVI\Latest_copper\best_model.pkl", 'rb') as f:
                    loaded_model = pickle.load(f)
                with open(r'C:\GUVI\Latest_copper\scaler.pkl', 'rb') as f:
                    scaler_loaded = pickle.load(f)

                with open(r"C:\GUVI\Latest_copper\item_type.pkl", 'rb') as f:
                    t_loaded = pickle.load(f)

                with open(r"C:\GUVI\Latest_copper\status.pkl", 'rb') as f:
    ...
    with tab2: 
            ...
            if csubmit_button and cflag==0:
                import pickle
                with open(r"C:\GUVI\Latest_copper\c_bestmodel.pkl", 'rb') as f:
                    cloaded_model = pickle.load(f)

                with open(r'C:\GUVI\Latest_copper\cscaler.pkl', 'rb') as f:
                    cscaler_loaded = pickle.load(f)

                with open(r"C:\GUVI\Latest_copper\c_item_type.pkl", 'rb') as f:
